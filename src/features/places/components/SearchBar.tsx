...
export const SearchBar = ({ value, onChange, totalResults, isFiltering }: SearchBarProps) => {
  ...
  return (
    <div className="relative group">
      <div className={cn("relative flex items-center transition-all duration-200", isFocused && "scale-[1.02]")}>
        <Search
          className={cn(
        ...
        {value && (
          <div className="absolute right-3 flex items-center gap-2">
            {isSearching ? (
              ...
              <Button variant="ghost" size="sm" className="h-6 w-6 p-0 hover:bg-muted-foreground/20" onClick={handleClear}>
      ...
      {isFiltering && (
        <div
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            {value && (
              <Button variant="link" className="h-auto p-0 text-sm font-normal" onClick={handleClear}>
                Clear search
              </Button>
            )}
          </div>
