...
import { Car, Clock, Euro, Thermometer, Train, Users } from "lucide-react";
...
export const PreferencesCard = ({
  ...
  const getBudgetLabel = (value: number) =>
    value < 33 ? "Budget-Friendly" : value < 66 ? "Mid-Range" : "Luxury";
  const getCrowdsLabel = (value: number) =>
    value < 33
      ? "Off the Beaten Path"
      : value < 66
      ? "Moderate Tourism"
  ...
  const getSeasonLabel = (value: number) =>
    value < 33 ? "Winter" : value < 66 ? "Spring/Fall" : "Summer";
  const getTransitLabel = (value: number) =>
    value < 33 ? "Basic" : value < 66 ? "Good" : "Excellent";
  const getDistanceLabel = (value: number) =>
    value < 33 ? "Remote" : value < 66 ? "Semi-Remote" : "Well-Connected";
      ...
      <CardContent className="space-y-8">
        <div className="space-y-6">
          ...
          <PreferenceSlider
            ...
            onChange={(crowds) =>
              onPreferencesChange({ ...preferences, crowds })
            }
          ...
          <PreferenceSlider
            ...
            onChange={(tripLength) =>
              onPreferencesChange({ ...preferences, tripLength })
            }
          ...
          <PreferenceSlider
            ...
            onChange={(season) =>
              onPreferencesChange({ ...preferences, season })
            }
          ...
          <PreferenceSlider
            ...
            onChange={(transit) =>
              onPreferencesChange({ ...preferences, transit })
            }
          ...
          <PreferenceSlider
            ...
            onChange={(accessibility) =>
              onPreferencesChange({ ...preferences, accessibility })
            }
